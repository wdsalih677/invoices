                                            ...
                                            <tbody>
                                                @foreach ( $invoices as $invoice )
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('getDetails' , $invoice->id) }}">{{ $invoice->section->section_name  }}</a>
                                                        </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div  class="dropdown-menu tx-13">
                                                                    <a class="dropdown-item" href="{{ route('invoices.edit',$invoice->id) }}"><i
                                                                        class="text-primary fas fa-edit"></i> تعديل الفاتوره </a>
                                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                        data-toggle="modal" data-target="#delete_invoice{{ $invoice->id }}"><i
                                                                            class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;حذف
                                                                            الفاتورة</a>
                                                                    <a class="dropdown-item" href="{{ url('show_status',$invoice->id) }}"><i
                                                                        class="text-success far fa-check-circle"></i> تعديل حالة الدفع </a>
                                                                </div>
                                                            </div>

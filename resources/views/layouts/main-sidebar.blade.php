				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoicesUnpaid') }}">الفواتير غير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ route('invoicesPartiallyPaid') }}">الفواتير المدفوعه جزئيا</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('section.index') }}">الأقسام</a></li>
						</ul>
					</li>
				</ul>
			</div>
